...
int main(void) {
    ...
    printf("float_val,fixed_val,float_sqrt,fixed_sqrt,scaled_float,fixed_err\n");
    ...
    while(q15_num0 < 32767){
        ...
        float float_sqrt = sqrt((float)q15_num0/32768.0);
        q15_t fixed_sqrt = q15_sqrt(q15_num0);
        
        /* scale the floating-point to fixed-point for comparison */
        float scaled_float = (float_sqrt * 32768.0);
        
        /* calculate the error in points */
        float fixed_err = scaled_float - (float)fixed_sqrt;
